    ...
    <>
      <div className="w-[96%] h-full">
        <div className="w-full h-full px-96 flex flex-col items-center gap-5">
          ...
          <button className="px-0 py-[15px] bg-[linear-gradient(to_left,#be2727,#A51B87)] text-[18px] rounded-full text-white font-medium mt-5 w-full max-w-[300px]">Logout</button>
